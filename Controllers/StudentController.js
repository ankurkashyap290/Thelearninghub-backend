  ...
  try {
    ...
    const newStudent = new Student({
     ...
     // student_adhaar: req.files.student_adhaar[0].filename,
      ...
      // student_admission: req.files.student_admission[0].filename,
      gender,
      dob,
      pin,
...
const updateStudent = async (req, res) => {
  try {
    ...
    // student.student_admission = req.files.student_admission[0].filename;
    ...
    // student.therapist = [...student.therapist, req.body.therapist];
    student.address = req.body.address;
    student.purpose = req.body.purpose;
    // student.class_left = req.body.class_left
